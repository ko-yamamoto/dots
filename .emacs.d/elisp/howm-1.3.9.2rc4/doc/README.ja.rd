...
= howm (一人お手軽 Wiki もどき)
$Id: README.ja.rd,v 1.309.2.6 2011-08-23 11:57:09 hira Exp $
...
* リリース予定版 howm-1.3.9.2rc4 [2011-08-23]
  * fix: 大きいフレームで一覧表示をしたときの余計なウィンドウ分割を修正
    ((<thx|URL:http://howm.sourceforge.jp/cgi-bin/hiki/hiki.cgi?BugReportPaste>))

* リリース予定版 howm-1.3.9.2rc3 [2011-03-20]
  * fix: configure 時の警告「suspicious cache-id」を回避
    * 対象は howm-1.3.9.2rc2 と howm-test110310 のみ
