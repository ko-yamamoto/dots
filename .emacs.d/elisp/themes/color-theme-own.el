...
(defun color-theme-nishikawasasaki ()
  "nishikawasasaki's theme    2011/03/06 "
  (interactive)
  (color-theme-install
   '(color-theme-clarity
     ...
     (isearch ((t (:background "OrangeRed" :foreground "brown4"))))
     (isearch-lazy-highlight-face ((t (:background "paleturquoise4"))))
     (italic ((t (:italic t :slant italic))))
     (menu ((t (nil))))
     (mode-line ((t (:foreground "black" :background "red" :box (:line-width -1 :style released-button)))))
