...
;;      (background-mode . light)
     ...
     (region ((t (:background "khaki" :foreground nil))))
     (link ((t (:underline t :foreground "dodger blue"))))
     (custom-link ((t (:inherit 'link))))
     (match ((t (:bold nil :background "#e9b96e" :foreground "#2e3436"))))
     ...
     (bold ((t (:bold nil :underline nil :background nil))))
     ...
     (font-lock-keyword-face ((t (:foreground "DeepSkyBlue3" :bold nil))))
     (font-lock-string-face ((t (:foreground "OliveDrab" :italic nil))))
     (font-lock-type-face ((t (:foreground "#8ae234" :bold nil))))
     (font-lock-variable-name-face ((t (:foreground "tomato"))))
     (font-lock-warning-face ((t (:bold nil :foreground "#f57900"))))
     (font-lock-function-name-face ((t (:foreground "#edd400" :bold nil))))
     ...
     (diary-face ((t (:bold nil :foreground "IndianRed"))))
     ...
     (moccur-edit-face ((t (:background "edd400"))))
)))
