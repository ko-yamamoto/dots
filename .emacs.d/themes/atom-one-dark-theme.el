...
(atom-one-dark-with-color-variables
  (custom-theme-set-faces
   ...
   ;; company-mode
   `(tooltip ((t (:foreground ,atom-one-dark-fg :background ,atom-one-dark-bg-1))))
   ...
   `(company-tooltip-common ((t (:foreground ,atom-one-dark-orange-1 :background ,atom-one-dark-bg-1))))
   `(company-tooltip-common-selection ((t (:foreground ,atom-one-dark-orange-1 :background ,atom-one-dark-gray))))
   `(company-preview ((t (:background ,atom-one-dark-bg))))
   `(company-preview-common ((t (:foreground ,atom-one-dark-mono-3 :background ,atom-one-dark-bg))))
   `(company-scrollbar-fg ((t (:background ,atom-one-dark-green))))
   ...
   ;; mozc
   `(mozc-cand-overlay-focused-face ((t (:foreground ,atom-one-dark-bg :background ,atom-one-dark-green))))
   `(mozc-cand-overlay-odd-face ((t (:foreground ,atom-one-dark-fg :background ,atom-one-dark-bg-1))))
   `(mozc-cand-overlay-even-face ((t (:foreground ,atom-one-dark-fg :background ,atom-one-dark-bg-1))))
   `(mozc-cand-overlay-footer-face ((t (:foreground ,atom-one-dark-bg :background ,atom-one-dark-orange-1))))
   `(mozc-preedit-selected-face ((t (:foreground ,atom-one-dark-bg :background ,atom-one-dark-orange-1))))

   ;;emacs-anzu
   `(anzu-mode-line ((t (:foreground ,atom-one-dark-red-1 :bold t))))

   ;; moccur
   `(moccur-face ((t (:foreground ,atom-one-dark-orange-1))))
   `(moccur-current-line-face ((t (:background ,atom-one-dark-bg-hl))))
